...
defined('UC_USER_CHECK_USERNAME_FAILED') or define('UC_USER_CHECK_USERNAME_FAILED', -1);
defined('UC_USER_USERNAME_BADWORD') or define('UC_USER_USERNAME_BADWORD', -2);
defined('UC_USER_USERNAME_EXISTS') or define('UC_USER_USERNAME_EXISTS', -3);
defined('UC_USER_EMAIL_FORMAT_ILLEGAL') or define('UC_USER_EMAIL_FORMAT_ILLEGAL', -4);
defined('UC_USER_EMAIL_ACCESS_ILLEGAL') or define('UC_USER_EMAIL_ACCESS_ILLEGAL', -5);
defined('UC_USER_EMAIL_EXISTS') or define('UC_USER_EMAIL_EXISTS', -6);
